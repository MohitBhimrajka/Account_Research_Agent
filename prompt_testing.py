...
def get_basic_prompt(
    company_name: str, platform_company_name: str, language: str = "Japanese"
):
    """Generates a prompt for a comprehensive basic company profile with all enhancements."""
    language_instruction = get_language_instruction(language)
    final_source_instructions = FINAL_SOURCE_LIST_INSTRUCTIONS_TEMPLATE.format(
        language=language
    )
...
def get_competitive_landscape_prompt(
    company_name: str, platform_company_name: str, language: str = "Japanese"
):
...
def get_management_strategy_prompt(
    company_name: str, platform_company_name: str, language: str = "Japanese"
):
...
def get_digital_transformation_prompt(
    company_name: str, platform_company_name: str, language: str = "Japanese"
):
...
def get_business_structure_prompt(
    company_name: str, platform_company_name: str, language: str = "Japanese"
):
    ...
    business_structure_completion_guidance = textwrap.dedent(
        f"""\
...
def get_management_message_prompt(
    company_name: str, platform_company_name: str, language: str = "Japanese"
):
